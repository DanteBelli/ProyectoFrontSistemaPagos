        ...
        <form action="" method="POST">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                 ...
                 <!-- Fecha ESIDIF -->
                 <div class="col-span-1">
                    <label for="campo_fecha2" class="block text-sm font-medium text-white">Fecha ESIDIF</label>
                    <input type="date" name="campo_fecha2" id="fechaEsidifOp" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                 <!-- Fecha Creacion -->
                 ...
                 <!-- Fecha Vencimiento -->
                 <div class="col-span-1">
                    <label for="campo_fecha2" class="block text-sm font-medium text-white">Fecha Vencimiento</label>
                    <input type="date" name="campo_fecha2" id="fechaVencOp" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Cuenta Pagadora-->
                ...
                <!-- Estado-->
                <div class="col-span-1">
                    <label for="campo_string1" class="block text-sm font-medium text-white">Estado</label>
                    <input type="text" name="campo_string1" id="estadoOp" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                 <!-- Letras Importe-->
                 <div class="col-span-1">
                    <input type="text" name="campo_string1" id="letrasImporteOp" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Importe -->
                ...
                <div class="tab-content mt-4">
                    ...
                    <div id="tab2" class="tab-content-item hidden">
                        ...
                        <div class="col-span-2">
                            <label for="campo_texto" class="block text-sm font-medium text-white"></label>
