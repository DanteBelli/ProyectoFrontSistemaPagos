<x-app-layout>
    <x-slot name="header">
        ...
        <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
            {{ __('Liquidacion Comedor Detalle') }}
        </h1>
    </x-slot>
    <div class="content">
        ...
        <form action="" method="POST">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div class="col-span-1">
                    ...
                    <input type="number" name="campo_numero1" id="nroComLiq" 
                ...
                <div class="col-span-1">
                    ...
                    <input type="number" name="campo_numero2" id="anioComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Fecha-->
                <div class="col-span-1">
                    ...
                    <input type="date" name="campo_fecha1" id="fechaComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Cuit -->
                <div class="col-span-1">
                    ...
                    <input type="text" name="campo_string1" id="cuitComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Razon Social -->
                <div class="col-span-1">
                    ...
                    <input type="text" name="campo_string1" id="razonSocialComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Fecha Vencimiento 1 -->
                <div class="col-span-1">
                    ...
                    <input type="date" name="campo_fecha2" id="fechaVencComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Fecha Vencimiento 2 -->
                <div class="col-span-1">
                    ...
                    <input type="date" name="campo_fecha3" id="fechaVenc2ComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- A favor -->
                <div class="col-span-1">
                    ...
                    <input type="text" name="campo_string2" id="afavorComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Exp Año -->
                <div class="col-span-1">
                    <label for="campo_string3" class="block text-sm font-medium text-white">CCA Año</label>
                    <input type="text" name="campo_string3" id="expAñoComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Estado -->
                <div class="col-span-1">
                    ...
                    <input type="text" name="campo_string4" id="estadoComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Importe -->
                <div class="col-span-1">
                    ...
                    <input type="number" step="0.01" name="campo_double" id="importeComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Retenciones -->
                <div class="col-span-1">
                    ...
                    <input type="number" step="0.01" name="campo_double" id="retencionesComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Importe a Pagar -->
                <div class="col-span-1">
                    ...
                    <input type="number" step="0.01" name="campo_double" id="importePagarComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                <!-- Importe Letras -->
                <div class="col-span-1">
                    ...
                    <input type="text" name="campo_string3" id="importeLetrasComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
                ...
                <div class="col-span-1">
                    ...
                    <input type="number" name="campo_numero2" id="cantComLiq" 
                        class="mt-1 block w-full bg-gray-200 border-gray-300 rounded-md shadow-sm" 
                        value="" readonly>
                </div>
            </div>
    ...
    <div class="container">
        ...
        <div class="tab-content mt-4">
            ...
            <!-- Botón Volver -->
            <div class="mt-6">
                <a href="{{ route('comedor.liq') }}" class="w-full bg-blue-500 text-white py-2 px-4 rounded-md hover:bg-blue-600 text-center inline-block">Volver</a>
            </div>
        </form>
    </div>
    </div>
