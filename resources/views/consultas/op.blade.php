    ...
    <div class="table-responsive">
        ...
        <div class="filter-container" style="margin-top: 20px;">
            <select id="category-filter" class="filter-field">
                ...
                <option value="proveedorNombre">CTA. Pagadora</option>
                <option value="tipoCompro">Estado</option>
                <option value="nroComprobante">Notas</option>
                <option value="nroComprobante">ID Cta. Paga</option>
                <option value="nroComprobante">ID Estado</option>
            </select>
            ...
            <button onclick="opConsultar()">Ver Detalle</button>
        </div>
    </div>
    <!-- Modal Error-->
