    ...
    <div class="table-responsive">
        ...
        <div class="filter-container" style="margin-top: 20px;">
            <select id="category-filter" class="filter-field">
                ...
                <option value="id">Nro ESIDIF</option>
                <option value="id">Periodo</option>
                <option value="nro">Año</option>
                <option value="anio">Importe</option>
                <option value="proveedorNombre">Estado</option>
                <option value="tipoCompro">ID Estado</option>
                <option value="nroComprobante">Verif_Por</option>
                <option value="nroComprobante">Rechazado Por</option>
                <option value="nroComprobante">Rechazado Motiv</option>
                <option value="nroComprobante">Notas</option>
                <option value="nroComprobante">ID Periodo</option>
            </select>
